...
class Level_Level2 extends RGBLevel
{
	//Stuff...
	...
	public function new(addToStage:Bool = true, onAddCallback:Dynamic = null, parentObject:Dynamic = null)
	{
		...
		// Generate maps.
		layerMap2 = addTilemap( Assets.getText("levels/mapCSV_Level2_Map2.csv"),"assets/WorkingTiles.png" ,0.000, 0.000, 0, 0, 1.000, 1.000, true, 1, 1, null, onAddCallback, false );
	...
	public function addSpritesForLayerLayer1(onAddCallback:Dynamic = null):Void
	{
		...
		obj.numberOfBlobs = 1;
		addSpriteToLayer(obj, Layer1Group , 63.000, 64.000, 0.000, 1, 1, false, 1.000, 1.000, null, onAddCallback );//"PlayerSpawn"
		var obj:com.charcoalStyles.rgb.entities.LevelEnd = new com.charcoalStyles.rgb.entities.LevelEnd();
		obj.setNumber = 1;
		addSpriteToLayer(obj, Layer1Group , 64.000, 192.000, 0.000, 1, 1, false, 1.000, 1.000, null, onAddCallback );//"LevelEnd"
		var obj:com.charcoalStyles.rgb.entities.LevelData = new com.charcoalStyles.rgb.entities.LevelData();
		obj.title = "Around The Bend";
		obj.subTitle = "";
		obj.isAllMove = true;
		addSpriteToLayer(obj, Layer1Group , 176.000, -68.000, 0.000, 1, 1, false, 1.000, 1.000, null, onAddCallback );//"LevelData"
	}
