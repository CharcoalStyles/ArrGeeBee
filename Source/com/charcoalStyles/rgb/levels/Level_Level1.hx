...
class Level_Level1 extends RGBLevel
{
	//Stuff...
	...
	public function new(addToStage:Bool = true, onAddCallback:Dynamic = null, parentObject:Dynamic = null)
	{
		...
		// Generate maps.
		layerMap2 = addTilemap( Assets.getText("levels/mapCSV_Level1_Map2.csv"),"assets/WorkingTiles.png" ,0.000, 0.000, 0, 0, 1.000, 1.000, true, 1, 1, null, onAddCallback, false );
	...
	public function addSpritesForLayerLayer1(onAddCallback:Dynamic = null):Void
	{
		...
		obj.setNumber = 1;
		addSpriteToLayer(obj, Layer1Group , 320.000, 64.000, 0.000, 1, 1, false, 1.000, 1.000, null, onAddCallback );//"LevelEnd"
		var obj:com.charcoalStyles.rgb.entities.LevelData = new com.charcoalStyles.rgb.entities.LevelData();
		obj.title = "Just Right";
		obj.subTitle = "";
		obj.isAllMove = true;
		addSpriteToLayer(obj, Layer1Group , 159.000, -72.000, 0.000, 1, 1, false, 1.000, 1.000, null, onAddCallback );//"LevelData"
	}
